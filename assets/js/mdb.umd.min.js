...
!(function (t, e) {
  "object" == typeof exports && "undefined" != typeof module
    ...
    : e(
        ((t =
          "undefined" != typeof globalThis ? globalThis : t || self).mdb = {})
      );
})(this, function (t) {
  "use strict";
  ...
  class be extends bt {
    ...
    _addEventListeners() {
      ut.on(this._element, me, (t) => {
        "Escape" === t.key &&
          (this._config.keyboard ? this.hide() : ut.trigger(this._element, pe));
      });
    }
  ...
  let bi = class t extends bt {
    ...
    _showElement(t) {
      ...
      e && (e.scrollTop = 0), Y(this._element), this._element.classList.add(fi);
      this._queueCallback(
        () => {
      ...
      if (E) {
        if (o) {
          var $,
            ...
            Q = M + Y - X,
            G = mn(p ? tn(S, M + V - X - K) : S, M, p ? Ji(I, Q) : I);
          (E[y] = G), (L[y] = G - M);
        }
        if (a) {
          var Z,
        ...
        h = {
          ...
          forceUpdate: function () {
            if (!c) {
              ...
              if (Xn(e, i)) {
                (a.rects = {
                  reference: Yn(e, pn(i), "fixed" === a.options.strategy),
                  popper: rn(i),
                }),
                  (a.reset = !1),
      ...
      for (const e of t)
        if ("click" === e)
          ...
          ut.on(this._element, t, this._config.selector, (t) => {
            ...
            (e._activeTrigger["focusin" === t.type ? ms : fs] = !0), e._enter();
          }),
            ut.on(this._element, i, this._config.selector, (t) => {
              const e = this._initializeOnDelegatedTarget(t);
              (e._activeTrigger[
                "focusout" === t.type ? ms : fs
    ...
    _addColor(t, e) {
      if (ia.find((t) => t === this._options.rippleColor.toLowerCase()))
        ...
        const e = this._colorToRGB(this._options.rippleColor).join(","),
          i = "rgba({{color}}, 0.2) 0, rgba({{color}}, 0.3) 40%, rgba({{color}}, 0.4) 50%, rgba({{color}}, 0.5) 60%, rgba({{color}}, 0) 70%"
            .split("{{color}}")
            .join(`${e}`);
      ...
      carousel: {
        ...
        callback: (t, e) => {
          const i = `click.bs.${t.name}.data-api`,
            ...
            o = e;
          D.on(document, i, "[data-mdb-slide], [data-mdb-slide-to]", function (
            t
          ) {
            const e = a(this);
